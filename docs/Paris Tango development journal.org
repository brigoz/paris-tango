...
#+CAPTION: Clock summary at [2019-03-13 Wed 11:57]
| Headline                                    |    Time |      |      |
|---------------------------------------------+---------+------+------|
| *Total time*                                | *27:18* |      |      |
|---------------------------------------------+---------+------+------|
...
| Deploying the New Website                   |    2:36 |      |      |
| \_  Change DNS records                      |         | 1:05 |      |
| \_  Implement final corrections             |         | 0:11 |      |
#+END:
