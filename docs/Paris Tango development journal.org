...
#+CAPTION: Clock summary at [2019-03-13 Wed 02:30]
| Headline                                    |    Time |      |      |
|---------------------------------------------+---------+------+------|
| *Total time*                                | *25:44* |      |      |
|---------------------------------------------+---------+------+------|
...
| Building the Site                           |   15:03 |      |      |
| \_  Preparation of new website repository   |         | 1:26 |      |
| \_  Preparation of special content types    |         | 1:59 |      |
| \_  Migration of existing content to new... |         | 4:08 |      |
| \_  Crafting a new look for the web site    |         | 7:30 |      |
| \_    Selecting and installing a theme      |         |      | 2:50 |
| \_    Customising the base theme            |         |      | 4:40 |
| Deploying the New Website                   |    2:25 |      |      |
