...
** Implement final corrections
   ...
   the entire photo gallery section, or just the separator with the title and subtitle.


* Time Log

#+BEGIN: clocktable :maxlevel 3 :scope file
#+CAPTION: Clock summary at [2019-03-20 Wed 18:26]
| Headline                                    |    Time |      |      |
|---------------------------------------------+---------+------+------|
| *Total time*                                | *33:46* |      |      |
|---------------------------------------------+---------+------+------|
...
| Deploying the New Website                   |    6:30 |      |      |
| \_  Change DNS records                      |         | 1:05 |      |
| \_  Implement final corrections             |         | 3:46 |      |
#+END:
